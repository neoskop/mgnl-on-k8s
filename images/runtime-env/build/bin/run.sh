...
export JAVA_OPTS="-Dlog4j2.formatMsgNoLookups=true -XX:InitialRAMPercentage=10 -XX:MaxRAMPercentage=80 -XX:MinRAMPercentage=50 -Djava.awt.headless=true -Dfile.encoding=UTF-8 $JAVA_OPTS"
